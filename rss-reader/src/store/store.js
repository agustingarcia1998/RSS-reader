...
export const useFeedStore = defineStore("feedStore", {
  ...
  actions: {
    async loadSource(source) {
      ...
      text = text.replace(/content:encoded/g, "content"); //transformo a content
    ...
    async registerNewSource(url) {
      try {
        ...
        const title =
          doc.querySelector("channel > title") || doc.querySelector("feed > title"); //encontrar etiqueta title dentro de channel
